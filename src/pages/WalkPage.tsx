        ...
        <div className="flex flex-col items-center">
          ...
          <div className="relative mb-5 flex h-40 w-40 items-center justify-center">
            ...
            <button
              ...
              className="absolute left-[81px] top-[111px] z-10 flex size-9 translate-y-1/2 items-center justify-center rounded-full border border-white/30 bg-gradient-to-b from-primary via-[#593d63] to-[#3d2845] text-[15px] font-bold leading-none text-white shadow-[inset_0_1px_0_rgba(255,255,255,0.38),inset_0_-3px_6px_rgba(0,0,0,0.22),0_4px_10px_rgba(105,10,207,0.3)] ring-1 ring-[#593d63]/25 transition-transform active:scale-95"
